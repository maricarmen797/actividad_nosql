...
# result_año_inspec %>%
# ggplot(aes(x=Count, y=reorder(`_id`$result, Count), group=`_id`$año_fecha, color=`_id`$año_fecha))+
# geom_bar(stat="identity")+geom_text(aes(label = Count), color = "black") +coord_flip()+xlab("Resultado inspección")
# 
# result_año_inspec %>%
# ggplot(aes(x=reorder(`_id`$año_fecha, Count),y=Count, group=`_id`$result, color=`_id`$result))+
# geom_bar(stat="identity")+geom_text(aes(label = Count), color = "black") +coord_flip()+xlab("Resultado inspección")
```
